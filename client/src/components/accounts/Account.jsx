  ...
  return (
    <div className="w-1/3 h-2/3 shadow-3xl rounded-2xl flex flex-col items-center justify-center px-6">
      <div className="flex w-full h-1/3 border-b-2 border-black justify-between items-end pb-3">
        <div>
          <h1 className="text-2xl font-bold mb-1">{data.account.name}</h1>
      ...
      <div className="h-1/3 w-full border-b-2 border-black pt-1">
        ...
        <p className="font-light text-sm border h-20 p-2">{data.account.description}</p>
      </div>

      <div className="h-1/3 w-full pt-1">
        <p className="font-bold text-lg h-8">Notes</p>
        <p className="font-light text-sm border h-20 p-2">{data.account.notes}</p>
      </div>
    </div>
  );
};
